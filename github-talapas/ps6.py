...
# creating plot
plt.plot(x, y, "o")
plt.title("k-mer49 Contig len (cutoff auto) (min contig 500) vs Number of contigs in this category")
plt.xlabel("Contig len (bp)")
plt.ylabel("Number of contigs in this category")
plt.savefig("k-mer49 Contig len (cutoff auto) (min contig 500) vs Number of contigs in this category.png")
plt.show()
